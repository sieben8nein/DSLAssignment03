...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalAccess().getIdAssignment_1(), "rule__External__IdAssignment_1");
			...
			builder.put(grammarAccess.getParameterAccess().getParamAssignment(), "rule__Parameter__ParamAssignment");
			builder.put(grammarAccess.getExternalUseAccess().getIdAssignment_0(), "rule__ExternalUse__IdAssignment_0");
