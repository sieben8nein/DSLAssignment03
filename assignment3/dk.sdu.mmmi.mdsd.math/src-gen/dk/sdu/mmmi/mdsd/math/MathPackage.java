...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL_USE__ID = EXPRESSION_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.External#getId <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Id</em>'.
   * @see dk.sdu.mmmi.mdsd.math.External#getId()
   * @see #getExternal()
   * @generated
   */
  EAttribute getExternal_Id();
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.Parameter#getParam <em>Param</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Param</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Parameter#getParam()
   * @see #getParameter()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.ExternalUse#getId <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Id</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalUse#getId()
   * @see #getExternalUse()
   * @generated
   */
  EAttribute getExternalUse_Id();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute EXTERNAL__ID = eINSTANCE.getExternal_Id();
     ...
     * @generated
     */
    EAttribute PARAMETER__PARAM = eINSTANCE.getParameter_Param();
     ...
     * @generated
     */
    EAttribute EXTERNAL_USE__ID = eINSTANCE.getExternalUse_Id();
